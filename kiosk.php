...
<head>
    ...
    <link rel="stylesheet" href="css/kiosk-560.css" media="screen and (min-width: 560px)">
    <link rel="stylesheet" href="css/kiosk-960.css" media="screen and (min-width: 960px)">
...
<body>
    ...
    <div class="mobile-link">
        <div class="QR">
            <img src="img/ynbqr.png" alt="スマホ版あきちのQRコード">
        </div>
        <div class="mobile-text">
            <h2>スマホであきち</h2>
            <p>QRコードからスマホ版あきちに<br>アクセスして好きなときに<br>その場で教室の空き状況をゲットしよう</p>
        </div>
    </div>
